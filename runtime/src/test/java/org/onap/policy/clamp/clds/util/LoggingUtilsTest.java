...
public class LoggingUtilsTest {
    ...
    public void testMarker() {
        ...
        logger.debug("line 3");
        logger.debug(LoggingUtils.METRIC_LOG_MARKER, "line 3 Metric");
        logger.debug(LoggingUtils.AUDIT_LOG_MARKER, "line 3 Audit");
        logger.debug(LoggingUtils.SECURITY_LOG_MARKER, "line 3 Security");
