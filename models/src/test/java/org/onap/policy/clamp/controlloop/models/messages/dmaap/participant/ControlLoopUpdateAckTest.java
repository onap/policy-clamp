...
class ControlLoopUpdateAckTest {

    @Test
    void testCopyConstructor() {
        assertThatThrownBy(() -> new ControlLoopUpdateAck(null)).isInstanceOf(NullPointerException.class);

        final ControlLoopUpdateAck orig = new ControlLoopUpdateAck();

        // verify with null values
        assertEquals(removeVariableFields(orig.toString()),
                removeVariableFields(new ControlLoopUpdateAck(orig).toString()));
