...
class AcElementDtoMapperTest {
    ...
    void testToInstanceElementDto() {
        ...
        assertDoesNotThrow(
            () -> AcElementDtoMapper.toInstanceElementDto(null, null));
        ...
        var instanceElementDto = AcElementDtoMapper.toInstanceElementDto(instanceId, acElement);
        ...
        instanceElementDto = AcElementDtoMapper.toInstanceElementDto(instanceId, acElement, ElementState.NEW);
    ...
    void testToCompositionElementDto() {
        ...
        var compositionElementDto = AcElementDtoMapper.toCompositionElementDto(acDefinition,
    ...
    void testBackwardCompatibility() throws Exception {
        ...
        var deserialized = mapper.readValue(jsonWithUnknownFields, AcElementDto.class);
        ...
        var deserializedWithRemoval = mapper.readValue(jsonWithRemovedField, AcElementDto.class);
