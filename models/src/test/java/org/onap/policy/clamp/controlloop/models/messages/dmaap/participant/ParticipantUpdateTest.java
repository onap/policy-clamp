...
class ParticipantUpdateTest {
    ...
    void testCopyConstructor() {
        ...
        orig.setControlLoopElementToscaServiceTemplate(toscaServiceTemplate);
        ...
        orig.setControlLoopElementDefinition(clDefinition);

        orig.setCommonPropertiesMap(commonPropertiesMap);
        ...
        orig.setControlLoopElementDefinitionMap(controlLoopElementDefinitionMap);
        ...
        assertNotSame(other.getControlLoopElementDefinition(), clDefinition);
        assertNotSame(other.getControlLoopElementToscaServiceTemplate(), toscaServiceTemplate);
    }
}
