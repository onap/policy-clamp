...
public class AcInstanceStateResolver {
    ...
    private static final String MIGRATION_ROLLBACKING = DeployState.MIGRATION_ROLLBACKING.name();
    ...
    public AcInstanceStateResolver() {
        ...
        // rollback
        addDeployOrderWithFail(MIGRATION_ROLLBACKING, MIGRATING, LOCKED, SUB_STATE_NONE);
        addDeployOrderWithFail(UNDEPLOY, MIGRATION_ROLLBACKING, LOCKED, SUB_STATE_NONE);
    }
