...
@NoArgsConstructor
public class AcElementDto {

    private CompositionElementDto compositionElement;
    private InstanceElementDto instanceElement;

    //nullable - only populated for update/migration
