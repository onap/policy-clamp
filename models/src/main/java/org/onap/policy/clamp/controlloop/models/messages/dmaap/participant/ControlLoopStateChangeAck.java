...
/**
 * Class to represent the CONTROLLOOP_STATECHANGE_ACK message that a participant sends
 * to control loop runtime as an acknowledgement to ControlLoopStateChange message.
 */
@Getter
@Setter
@ToString(callSuper = true)
public class ControlLoopStateChangeAck extends ParticipantAckMessage {
    ...
    /**
     * Constructor for instantiating ControlLoopStateChangeAck class with message name.
     *
     */
    public ControlLoopStateChangeAck() {
        super(ParticipantMessageType.CONTROLLOOP_STATECHANGE_ACK);
    }
     ...
     */
    public ControlLoopStateChangeAck(final ControlLoopStateChangeAck source) {
        super(source);
