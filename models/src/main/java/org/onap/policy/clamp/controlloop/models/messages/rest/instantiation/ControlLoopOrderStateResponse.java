...
public class ControlLoopOrderStateResponse extends SimpleResponse {
    ...
    public ControlLoopOrderStateResponse() {
        orderedState = ControlLoopOrderedState.UNINITIALISED;
        controlLoopIdentifierList = new ArrayList<>();
    }

    private ControlLoopOrderedState orderedState;

    List<ControlLoopNameVersion> controlLoopIdentifierList;
}
