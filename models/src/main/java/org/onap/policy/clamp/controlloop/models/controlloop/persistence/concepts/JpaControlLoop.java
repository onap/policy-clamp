...
public class JpaControlLoop extends PfConcept implements PfAuthorative<ControlLoop> {
    ...
    public int compareTo(final PfConcept otherConcept) {
        ...
        builder.append(this.definition, other.definition);
        builder.append(this.state, other.state);
        builder.append(this.orderedState, other.orderedState);
        builder.append(this.description, other.description);

        for (JpaControlLoopElement element : elements.values()) {
            builder.append(this.elements.get(element.getKey()),
                        other.elements.get(element.getKey()));
        }
