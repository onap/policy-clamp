...
public class AutomationComposition extends ToscaEntity {
    ...
    private Boolean neverDeployed = Boolean.TRUE;
    ...
    @NotNull
    @Valid
    private Map<@NotNull UUID, @NotNull AutomationCompositionElement> elements;
    ...
    public AutomationComposition(final AutomationComposition otherAutomationComposition) {
        ...
        this.neverDeployed = otherAutomationComposition.neverDeployed;
