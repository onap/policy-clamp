...
public class DocToscaWithTypeAndStringProperties<T extends ToscaWithTypeAndObjectProperties> extends DocToscaEntity<T> {
    ...
    /**
     * Override parent's getType() to return the actual type field value.
     * We keep @JsonIgnore because the @JsonProperty on the field handles serialization.
     */
    @Override
    @JsonIgnore
    ...
    /**
     * Override parent's getTypeVersion() to return the actual typeVersion field value.
     * We keep @JsonIgnore because the @JsonProperty on the field handles serialization.
     */
    @Override
    @JsonIgnore
