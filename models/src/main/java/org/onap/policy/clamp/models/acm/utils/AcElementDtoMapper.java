...
/**
 * Utility class that constructs the DTOs for participant use.
 */
@NoArgsConstructor(access = AccessLevel.PRIVATE)
public final class AcElementDtoMapper {
     ...
     */
    public static InstanceElementDto toInstanceElementDto(UUID instanceId, AutomationCompositionElement element,
                                                          ElementState state) {
        if (element == null) {
     ...
     */
    public static CompositionElementDto toCompositionElementDto(AutomationCompositionDefinition acDefinition,
