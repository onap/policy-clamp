...
/**
 * Class to represent the CONTROLLOOP_UPDATE_ACK message that a participant sends
 * to control loop runtime as an acknowledgement to ControlLoopUpdate message.
 */
@Getter
@Setter
@ToString(callSuper = true)
public class ControlLoopUpdateAck extends ParticipantAckMessage {
     ...
     *
     */
    public ControlLoopUpdateAck() {
        super(ParticipantMessageType.CONTROLLOOP_UPDATE_ACK);
    }
     ...
     */
    public ControlLoopUpdateAck(final ControlLoopUpdateAck source) {
        super(source);
