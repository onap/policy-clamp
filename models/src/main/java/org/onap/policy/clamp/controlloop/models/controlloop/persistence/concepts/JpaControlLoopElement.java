...
public class JpaControlLoopElement extends PfConcept implements PfAuthorative<ControlLoopElement> {
    ...
    public int compareTo(final PfConcept otherConcept) {
        ...
        return new CompareToBuilder()
                ...
                .append(this.definition, other.definition)
                .append(this.participantType, other.participantType)
                .append(this.participantId, other.participantId)
                .append(this.state, other.state)
                .append(this.orderedState, other.orderedState)
                .append(this.description, other.description).toComparison();
        // @formatter:on
    }
}
