...
public class ParticipantUpdate extends ParticipantMessage {
    ...
    // A map with Participant ID as its key, each participant can hold multiple ControlLoopElements.
    // This map will hold a participantID as key, and a ControlLoopElementDefintionMap as value.
    private Map<ToscaConceptIdentifier, Map<UUID, ControlLoopElementDefinition>>
            participantDefinitionUpdateMap = new LinkedHashMap<>();

    // A map of ControlLoopElementDefinitions. The keys of this map are the ControlLoopElementDefinition IDs.
