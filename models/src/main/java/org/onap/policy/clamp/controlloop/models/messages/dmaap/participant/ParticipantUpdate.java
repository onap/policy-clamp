...
public class ParticipantUpdate extends ParticipantMessage {
    ...
    public ParticipantUpdate(ParticipantUpdate source) {
        ...
        this.participantDefinitionUpdateMap = source.participantDefinitionUpdateMap;
        this.controlLoopElementDefinitionMap =
                PfUtils.mapMap(source.controlLoopElementDefinitionMap, ControlLoopElementDefinition::new);
        ...
        this.commonPropertiesMap = PfUtils.mapMap(source.commonPropertiesMap, String::new);
