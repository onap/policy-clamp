...
public class CommonCommandLineArgumentsTest {
    ...
    public void testVersion() {
        CommonCommandLineArguments cliMock = mock(CommonCommandLineArguments.class);
        when(cliMock.version()).thenReturn("version.txt");
        assertThat(cliMock.version()).contains("version.txt");
    }
