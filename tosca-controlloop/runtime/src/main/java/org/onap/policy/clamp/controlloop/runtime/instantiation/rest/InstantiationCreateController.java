...
/**
 * Class to provide REST end points for creating a control loop definition.
 */
public class InstantiationCreateController extends RestController {
    private static final Logger LOGGER = LoggerFactory.getLogger(InstantiationCreateController.class);

    // The CL provider for instantiation requests
    private final ControlLoopInstantiationProvider provider;

    /**
     * create Instantiation Create Controller.
     */
    public InstantiationCreateController() {
        super();
