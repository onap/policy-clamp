...
public class SupervisionHandler extends ControlLoopHandler {
    ...
    public void startAndRegisterPublishers(List<TopicSink> topicSinks) {
        ...
        try {
            ...
            LOGGER.error("Supervision handler start of publishers or scanner failed");
        }
    }
    ...
    public void stopAndUnregisterPublishers() {
        try {
            ...
            LOGGER.error("Supervision Handler stop of publishers or scanner failed");
        }
    }
    ...
    public void startProviders() {
        try {
            ...
            LOGGER.error("Supervision Handler start of providers failed");
        }
    }
    ...
    public void stopProviders() {
        try {
            ...
            LOGGER.error("Supervision Handler stop of providers failed");
        }
    }
