...
public class ParticipantStatisticsProviderTest {
    ...
    private static final String PARTICIPANT_STATS_JSON =
        "src/test/resources/providers/TestParticipantStatistics.json";
    ...
    public void testParticipantStatisticsCreate() throws Exception {
        ...
        createdStatsList.setParticipantStatisticsList(participantStatisticsProvider
            .createParticipantStatistics(inputParticipantStatistics.getParticipantStatisticsList()));
    ...
    public void testGetControlLoops() throws Exception {
        ...
        participantStatisticsProvider.createParticipantStatistics(inputParticipantStatistics
            .getParticipantStatisticsList());
        ToscaConceptIdentifier identifier = inputParticipantStatistics.getParticipantStatisticsList().get(0)
            .getParticipantId();
        Date date = inputParticipantStatistics.getParticipantStatisticsList().get(0).getTimeStamp();
        assertEquals(1, participantStatisticsProvider.getParticipantStatistics(identifier.getName(),
            identifier.getVersion(), date).size());

        assertEquals(1, participantStatisticsProvider.getFilteredParticipantStatistics("name2",
