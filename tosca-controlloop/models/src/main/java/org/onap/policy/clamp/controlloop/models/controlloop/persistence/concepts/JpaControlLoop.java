...
public class JpaControlLoop extends PfConcept implements PfAuthorative<ControlLoop> {
    ...
    @Column
    private ControlLoopState orderedState;
    ...
    public JpaControlLoop(@NonNull final PfConceptKey key) {
        this(key, new PfConceptKey(), ControlLoopState.UNINITIALIZED, new ArrayList<>());
    }
    ...
    public ControlLoop toAuthorative() {
        ...
        controlLoop.setOrderedState(orderedState != null ? orderedState : state);
        controlLoop.setDescription(description);

        controlLoop.setElements(new ArrayList<>(elements.size()));
        for (JpaControlLoopElement element : elements) {
            controlLoop.getElements().add(element.toAuthorative());
        }
    ...
    public void fromAuthorative(@NonNull final ControlLoop controlLoop) {
        ...
        this.orderedState =
                (controlLoop.getOrderedState() != null ? controlLoop.getOrderedState() : controlLoop.getState());
