...
public class ParticipantStatisticsProvider extends AbstractModelsProvider {
     ...
     */
    public ParticipantStatisticsProvider(@NonNull PolicyModelsProviderParameters parameters)
    ...
    public List<ParticipantStatistics> getParticipantStatistics(
        ...
        if (name != null && version != null && timestamp != null) {
            participantStatistics
                .add(getPfDao().get(JpaParticipantStatistics.class, new PfTimestampKey(name,
                version, timestamp))
                .toAuthorative());
        } else {
    ...
    public List<ParticipantStatistics> createParticipantStatistics(
        ...
        for (ParticipantStatistics participantStatistics : participantStatisticsList) {
            ...
            BeanValidationResult validationResult = jpaParticipantStatistics.validate("participant statistics");
        ...
        for (ParticipantStatistics participantStatisticsItem : participantStatisticsList) {
            JpaParticipantStatistics jpaParticipantStatistics =
                getPfDao().get(JpaParticipantStatistics.class,
     ...
     */
    private List<ParticipantStatistics> asParticipantStatisticsList(List<JpaParticipantStatistics>
                                                               jpaParticipantStatisticsList) {
        return jpaParticipantStatisticsList.stream()
          .map(JpaParticipantStatistics::toAuthorative).collect(Collectors.toList());
    }
}
