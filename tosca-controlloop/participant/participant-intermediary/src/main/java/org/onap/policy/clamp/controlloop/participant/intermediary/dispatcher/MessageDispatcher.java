...
package org.onap.policy.clamp.controlloop.participant.intermediary.dispatcher;
...
/**
 * This class dispatches messages from participants to CLAMP.
 */
public class MessageDispatcher extends TimerTask implements Closeable {
     ...
     * @param publisher the publisher to use for dispatching messages
     * @param interval time interval to send Participant Status periodic messages
     */
    public MessageDispatcher(ParticipantHandler participantHandler, ParticipantStatusPublisher publisher,
            long interval) {
     ...
     */
    public void dispatchResponse(ParticipantResponseDetails response) {
     ...
     * @param response the details to include in the response message
     */
    public void dispatchResponse(ToscaConceptIdentifier controlLoopId, ParticipantResponseDetails response) {
