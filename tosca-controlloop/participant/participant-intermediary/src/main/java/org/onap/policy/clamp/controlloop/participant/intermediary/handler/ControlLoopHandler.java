...
public class ControlLoopHandler implements Closeable {
    ...
    private Map<UUID, ControlLoopElement> elementsOnThisParticipant = new LinkedHashMap<>();
    ...
    public ControlLoopElement updateControlLoopElementState(UUID id, ControlLoopOrderedState state) {
        ...
        if (elementsOnThisParticipant.get(id) != null) {
            elementsOnThisParticipant.get(id).setOrderedState(state);
