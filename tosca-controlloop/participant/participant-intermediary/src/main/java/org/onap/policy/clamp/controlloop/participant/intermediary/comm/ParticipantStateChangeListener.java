...
public class ParticipantStateChangeListener extends ScoListener<ParticipantStateChange> implements Closeable {
    ...
    public void onTopicEvent(final CommInfrastructure infra, final String topic, final StandardCoderObject sco,
        ...
        if (participantHandler.appliesTo(participantStateChangeMsg)) {
            LOGGER.debug("Message for this participant - {}", participantStateChangeMsg);
            participantHandler.handleParticipantStateChange(participantStateChangeMsg);
        } else {
            LOGGER.debug("Message not for this participant - {}", participantStateChangeMsg);
        }
    }
