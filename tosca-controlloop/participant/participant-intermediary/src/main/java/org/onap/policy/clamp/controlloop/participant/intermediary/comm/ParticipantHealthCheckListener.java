...
public class ParticipantHealthCheckListener extends ScoListener<ParticipantHealthCheck> implements Closeable {
    ...
    public void onTopicEvent(final CommInfrastructure infra, final String topic, final StandardCoderObject sco,
        ...
        if (participantHandler.appliesTo(participantHealthCheckMsg)) {
            LOGGER.debug("Message for this participant - {}", participantHealthCheckMsg);
            participantHandler.handleParticipantHealthCheck(participantHealthCheckMsg);
        } else {
            LOGGER.debug("Message not for this participant - {}", participantHealthCheckMsg);
        }
