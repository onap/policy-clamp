...
public abstract class AbstractHttpClient implements Closeable {
     ...
     * constructor.
     */
    public AbstractHttpClient(RestServerParameters restServerParameters) {
        try {
    ...
    CloseableHttpResponse execute(HttpRequest request) throws IOException, ClientProtocolException {
