...
/**
 * Class to perform unit test of {@link ParticipantConstants}}.
 */
public class TestParticipantConstants {
    @Test
    public void test() throws Exception {
        // verify that constructor does not throw an exception
        assertThatCode(() -> Whitebox.invokeConstructor(ControlLoopConstants.class)).doesNotThrowAnyException();
    }
}
