...
public class PdpGroupAnalyzerTest {
    ...
    public void testGetSupportedPdpGroupsForPolicy() throws IOException {
        ...
        assertThat(
                JsonUtils.GSON.toJson(pdpGroupsAnalyzer.getSupportedPdpGroupsForPolicy("org.onap.testos", "2.0.0")))
                .isEqualTo(ResourceFileUtils.getResourceAsString("example/policy/pdp-deployment-testos-2_0_0.json"));

        assertThat(
                JsonUtils.GSON.toJson(pdpGroupsAnalyzer.getSupportedPdpGroupsForPolicy("org.onap.testos", "1.0.0")))
                .isEqualTo(ResourceFileUtils.getResourceAsString("example/policy/pdp-deployment-testos-1_0_0.json"));

        assertThat(
                pdpGroupsAnalyzer.getSupportedPdpGroupsForPolicy("org.onap.donotexist", "1.0.0"))
                .isEqualTo(null);
    }
