...
public class PolicyModelServiceItCase {
    ...
    public void shouldGetPolicyModelInJson() throws IOException {
        PolicyModel policyModel = policyModelsService
                .createNewPolicyModelFromTosca(ResourceFileUtils.getResourceAsString("tosca/tosca_with_metadata.yaml"));
        ...
        JSONAssert.assertEquals(ResourceFileUtils.getResourceAsString("tosca/tosca_with_metadata.json"),
