...
export default class ViewAllPolicies extends React.Component {
  state = {
    ...
    handleOnPolicyRowClick(rowData) {
                        ...
                        <Modal.Body>
                          <FormControlLabel
                           ...
                           <MaterialTable
                              ...
                              //onRowClick={(event, rowData) => {this.handleOnPolicyRowClick(rowData)}}
                              options={{
                                  grouping: true,
                                  exportButton: true,
                              ...
                              detailPanel={[
                                {
                                  ...
                                  render: rowData => {
                                    return (
                                        <DetailedRow>
                                            <PolicyEditor policyData={rowData} />
                                        </DetailedRow>
                                    )
                                  },
                                },
                        ...
                        <Modal.Body>
                          <FormControlLabel
                           ...
                           <MaterialTable
                              ...
                              icons={this.state.tableIcons}
                              onRowClick={(event, rowData) => {this.handleOnToscaRowClick(rowData)}}
                              options={{
                                  grouping: true,
                                  exportButton: true,
                                  headerStyle:rowHeaderStyle,
