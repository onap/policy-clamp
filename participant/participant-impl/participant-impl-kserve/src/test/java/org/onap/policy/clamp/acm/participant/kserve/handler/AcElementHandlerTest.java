...
class AcElementHandlerTest {
    ...
    void test_automationCompositionElementStateChange()
        ...
        var automationCompositionElementHandler = spy(new AutomationCompositionElementHandler(
                participantIntermediaryApi, kserveClient, MapperFactory.createJsonMapper()));
    ...
    void test_automationCompositionElementWrongData() {
        ...
        var automationCompositionElementHandler = new AutomationCompositionElementHandler(
                participantIntermediaryApi, kserveClient, new ObjectMapper());
