...
public class ParticipantK8sParameterHandler {
    private static final Logger LOGGER = LoggerFactory.getLogger(ParticipantK8sParameterHandler.class);
    ...
    public ParticipantK8sParameters toParticipantK8sParameters(String path) throws ControlLoopException {
        ...
        if (!validationResult.isValid()) {
            String returnMessage = "validation error(s) on parameters from \"" + path + "\"\n";
