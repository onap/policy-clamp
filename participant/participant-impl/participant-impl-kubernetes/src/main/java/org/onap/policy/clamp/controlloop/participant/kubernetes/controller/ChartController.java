...
public class ChartController {
    ...
    public ResponseEntity<ChartList> getAllCharts() {
        Collection<ChartInfo> charts = new ArrayList<>();
        chartService.getAllCharts().forEach(chart -> charts.add(chart));
        ChartList list = ChartList.builder().charts(charts).build();
    ...
    public ResponseEntity<Object> installChart(@RequestBody InstallationInfo info) throws ServiceException,
        IOException {
    ...
    public ResponseEntity<Object> uninstallChart(//
    ...
    public ResponseEntity<String> onboardChart(//
                                               ...
                                               @RequestParam(name = "values", required = false)
                                                           MultipartFile overrideFile,
                                               @RequestParam("info") String infoJson) throws ServiceException,
                                               IOException {

        ChartInfo info = gson.fromJson(infoJson, ChartInfo.class);
