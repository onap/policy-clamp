...
class ControlLoopElementHandlerTest {
    ...
    void test_ControlLoopElementStateChange() throws ServiceException {
        ...
        controlLoopElementHandler.chartMap.put(controlLoopElementId1, charts.get(0));
        controlLoopElementHandler.chartMap.put(controlLoopElementId2, charts.get(1));
    ...
    void test_ControlLoopElementUpdate() throws PfModelException, IOException, ServiceException {
        ...
        assertThat(controlLoopElementHandler.chartMap).hasSize(1).containsKey(elementId1);
        ...
        assertThat(controlLoopElementHandler.chartMap.containsKey(elementId2)).isFalse();
    }
}
