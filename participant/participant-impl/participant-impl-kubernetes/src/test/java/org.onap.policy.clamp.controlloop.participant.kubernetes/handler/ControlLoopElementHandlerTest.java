...
public class ControlLoopElementHandlerTest {
    ...
    @BeforeAll
    public static void init() throws CoderException {
    ...
    void test_ControlLoopElementUpdate() throws PfModelException, IOException, ServiceException {
        ...
        assertThat(controlLoopElementHandler.getChartMap().size()).isEqualTo(1);
        assertThat(controlLoopElementHandler.getChartMap().containsKey(elementId1));
        ...
        assertFalse(controlLoopElementHandler.getChartMap().containsKey(elementId2));
    }
}
