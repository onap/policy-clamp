...
class AcElementControllerTest {
    ...
    void retrieveElementConfig() throws Exception {
        ...
        requestBuilder = MockMvcRequestBuilders.get(RETRIEVE_CONFIG).accept(MediaType.APPLICATION_JSON_VALUE);
    ...
    void deActivateConfig() throws Exception {
        ...
        requestBuilder = MockMvcRequestBuilders.delete(DEACTIVATE_CONFIG);
