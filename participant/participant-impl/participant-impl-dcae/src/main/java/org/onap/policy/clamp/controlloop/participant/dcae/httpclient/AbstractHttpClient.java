...
public abstract class AbstractHttpClient implements Closeable {
    ...
    protected Loop executePost(String path, int statusCode) {
        try {
            ...
            return entityToMap(response.readEntity(String.class));
        } catch (Exception e) {
    ...
    private Loop entityToMap(String entity) {
        if (entity == null) {
            return new Loop();
        }
        try {
            return CODER.convert(entity, Loop.class);
