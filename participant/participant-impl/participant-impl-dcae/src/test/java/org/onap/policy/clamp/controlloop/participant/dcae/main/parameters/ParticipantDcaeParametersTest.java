...
class ParticipantDcaeParametersTest {
    ...
    void testNoName() {
        final ParticipantDcaeParameters participantParameters = commonTestData.getParticipantDcaeParameters();
        participantParameters.setName(null);
    ...
    @Test
    void testNoClampClientHostname() throws ControlLoopException {
        final ParticipantDcaeParameters participantParameters = commonTestData.getParticipantDcaeParameters();
    ...
    @Test
    void testClampClientPortZero() throws ControlLoopException {
        final ParticipantDcaeParameters participantParameters = commonTestData.getParticipantDcaeParameters();

        participantParameters.getClampClientParameters().setPort(0);
