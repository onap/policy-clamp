...
public class PolicyApiHttpClient extends AbstractHttpClient {
    ...
    public Response createPolicy(final ToscaServiceTemplate toscaServiceTemplate) {
        ...
        return executePost(POLICY_URI + "policytypes/" + policy.getType() + "/versions/" + policy.getTypeVersion()
                + "/policies", Entity.entity(toscaServiceTemplate, MediaType.APPLICATION_JSON));
    }
