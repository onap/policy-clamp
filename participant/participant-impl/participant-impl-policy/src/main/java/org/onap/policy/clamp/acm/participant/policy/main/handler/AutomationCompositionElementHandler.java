...
public class AutomationCompositionElementHandler implements AutomationCompositionElementListener {
    ...
    public void automationCompositionElementStateChange(ToscaConceptIdentifier automationCompositionId,
        ...
        switch (orderedState) {
            ...
            case RUNNING:
                try {
                    deployPolicies(automationCompositionId, automationCompositionElementId, orderedState);
                } catch (PfModelRuntimeException e) {
                    LOGGER.debug("Deploying policies failed {}", automationCompositionElementId);
                }
                break;
            default:
