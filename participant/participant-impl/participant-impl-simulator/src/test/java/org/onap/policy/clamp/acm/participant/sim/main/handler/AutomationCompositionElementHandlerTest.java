...
class AutomationCompositionElementHandlerTest {
    ...
    void testDeploy() {
        ...
        verify(intermediaryApi).updateAutomationCompositionElementState(
            new ElementStateDto(INSTANCE_ELEMENT.instanceId(), INSTANCE_ELEMENT.elementId(), DeployState.DEPLOYED,
                StateChangeResult.NO_ERROR, "Deployed", INSTANCE_ELEMENT.outProperties()));
    ...
    void testUndeploy() {
        ...
        verify(intermediaryApi).updateAutomationCompositionElementState(
            new ElementStateDto(INSTANCE_ELEMENT.instanceId(), INSTANCE_ELEMENT.elementId(), DeployState.UNDEPLOYED,
                StateChangeResult.NO_ERROR, "Undeployed", INSTANCE_ELEMENT.outProperties()));
    ...
    void testUpdate() {
        ...
        verify(intermediaryApi).updateAutomationCompositionElementState(new ElementStateDto(
            ...
            StateChangeResult.NO_ERROR, "Updated", instanceElementUpdated.outProperties()));
    ...
    void testDelete() {
        ...
        verify(intermediaryApi).updateAutomationCompositionElementState(new ElementStateDto(
            ...
            StateChangeResult.FAILED, "Delete failed!", INSTANCE_ELEMENT.outProperties()));
    }
    ...
    void testMigrate() {
        ...
        verify(intermediaryApi).updateAutomationCompositionElementState(new ElementStateDto(
            INSTANCE_ELEMENT.instanceId(), INSTANCE_ELEMENT.elementId(),
            DeployState.DEPLOYED, StateChangeResult.NO_ERROR, "Migrated", instanceElementMigrated.outProperties()));
    ...
    void testMigrateAdd() {
        ...
        verify(intermediaryApi).updateAutomationCompositionElementState(new ElementStateDto(
            ...
            DeployState.DEPLOYED, StateChangeResult.NO_ERROR, "Migrated", inElMigratedAdd.outProperties()));
    }
    ...
    void testMigratePrecheck() {
        ...
        verify(intermediaryApi).updateAutomationCompositionElementState(new ElementStateDto(
            INSTANCE_ELEMENT.instanceId(), INSTANCE_ELEMENT.elementId(), DeployState.DEPLOYED,
            StateChangeResult.NO_ERROR, "Migration precheck completed", instanceElementMigrated.outProperties()));
    ...
    void testPrepare() {
        ...
        verify(intermediaryApi).updateAutomationCompositionElementState(new ElementStateDto(
            INSTANCE_ELEMENT.instanceId(), INSTANCE_ELEMENT.elementId(), DeployState.UNDEPLOYED,
            StateChangeResult.NO_ERROR, "Prepare completed", INSTANCE_ELEMENT.outProperties()));
    ...
    void testReview() {
        ...
        verify(intermediaryApi).updateAutomationCompositionElementState(new ElementStateDto(
            INSTANCE_ELEMENT.instanceId(), INSTANCE_ELEMENT.elementId(), DeployState.DEPLOYED,
            StateChangeResult.NO_ERROR, "Review completed", INSTANCE_ELEMENT.outProperties()));
