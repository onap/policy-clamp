...
package org.onap.policy.clamp.acm.participant.a1.utils;
...
public class CommonTestData {
    ...
    private static final String TEST_KEY_NAME = "org.onap.domain.database.A1PMS_AutomationCompositionElement";
    ...
    public ToscaConceptIdentifier getAutomationCompositionId() {
        return new ToscaConceptIdentifier("A1PMSInstance0", "1.0.0");
    }
     ...
     */
    public List<PolicyServiceEntity> getValidPolicyEntities() {
        PolicyServiceEntity policyServiceEntity1 = new PolicyServiceEntity("testService1", "http://localhost",
                0);
        PolicyServiceEntity policyServiceEntity2 = new PolicyServiceEntity("testService2", "http://127.0.0.1",
                0);
        return List.of(policyServiceEntity1, policyServiceEntity2);
    }
}
