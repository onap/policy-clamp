...
public class KafkaConfig {
    ...
    // Boot 4 uses management.tracing.export.enabled; Boot 3.x uses management.tracing.enabled
    @Value("${management.tracing.export.enabled:${management.tracing.enabled:false}}")
    ...
    public KafkaTemplate<String, ParticipantKafkaMessage> acmKafkaTemplate(
            ProducerFactory<String, ParticipantKafkaMessage> acmProducerFactory,
            ParticipantParameters participantParameters) {
        var template = new KafkaTemplate<>(acmProducerFactory);
        template.setObservationEnabled(tracingEnabled);
        return template;
    }
    ...
    public ConcurrentKafkaListenerContainerFactory<String, ParticipantKafkaMessage> acmListenerContainerFactory(
            ConsumerFactory<String, ParticipantKafkaMessage> acmConsumerFactory,
            ParticipantParameters participantParameters) {
        var kafka = participantParameters.getIntermediaryParameters().getKafka();
        ...
        factory.getContainerProperties().setObservationEnabled(tracingEnabled);
