...
class ParticipantMessageListenerSpec extends Specification {
    ...
    def "should handle #messageType when appliesTo"() {
        ...
        new ParticipantPrime()               | "handleParticipantPrime"                   | "ParticipantPrime"
        new AutomationCompositionDeploy()    | "handleAutomationCompositionDeploy"        | "AutomationCompositionDeploy"
        new AutomationCompositionStateChange() | "handleAutomationCompositionStateChange" | "AutomationCompositionStateChange"
        new AutomationCompositionPrepare()   | "handleAutomationCompositionPrepare"       | "AutomationCompositionPrepare"
        new AutomationCompositionMigration() | "handleAutomationCompositionMigration"     | "AutomationCompositionMigration"
        new PropertiesUpdate()               | "handleAcPropertyUpdate"                   | "PropertiesUpdate"
        new ParticipantDeregisterAck()       | "handleParticipantDeregisterAck"           | "ParticipantDeregisterAck"
    }
