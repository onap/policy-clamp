...
public class ParticipantDeregisterAckPublisher extends AbstractParticipantAckPublisher<ParticipantDeregisterAck> {
    ...
    /**
     * Constructor for instantiating ParticipantDeregisterAck.
     *
     * @param topicSinks the topic sinks
     * @param interval time interval to send ParticipantDeregisterAck messages
     */
    public ParticipantDeregisterAckPublisher(final List<TopicSink> topicSinks, final long interval) {
