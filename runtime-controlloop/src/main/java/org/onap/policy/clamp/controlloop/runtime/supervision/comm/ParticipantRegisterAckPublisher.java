...
public class ParticipantRegisterAckPublisher extends AbstractParticipantAckPublisher<ParticipantRegisterAck> {
    ...
    /**
     * Constructor for instantiating ParticipantRegisterAck.
     *
     * @param topicSinks the topic sinks
     * @param interval time interval to send ParticipantRegisterAck messages
     */
    public ParticipantRegisterAckPublisher(final List<TopicSink> topicSinks, final long interval) {
