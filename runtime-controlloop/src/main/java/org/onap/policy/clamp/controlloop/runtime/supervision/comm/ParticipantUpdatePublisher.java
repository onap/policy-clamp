...
public class ParticipantUpdatePublisher extends AbstractParticipantPublisher<ParticipantUpdate> {
    ...
    /**
     * Constructor for instantiating ParticipantUpdate.
     *
     * @param topicSinks the topic sinks
     * @param interval time interval to send ParticipantUpdate messages
     */
    public ParticipantUpdatePublisher(final List<TopicSink> topicSinks, final long interval) {
