 ...
 * {@code @ConditionalOnMissingBean otelSampler()} and makes that property inert, which is why
 * {@link OpenTelemetryConfig}'s remote sampler has to stay opt-in and unconfigured by default.
 */
