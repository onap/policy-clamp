...
class ParticipantControllerTestHelper {
    ...
    def sendGetNoAuth(String url) {
        return client.sendGetNoAuth(url)
    }
    ...
    def sendPutNoAuth(String url) {
        return client.sendPutNoAuth(url)
    }
    ...
    static def getNumberRecords() {
        return NUMBER_RECORDS
    }

    static def sampleParticipant() {
    ...
    def validatePageable(String url, int expected) {
    ...
    def validateNotPageable(String url, int expected) {
        def info = getParticipantInfo(url)
        assert info.acNodeTemplateStateDefinitionMap.size() >= expected
        assert info.acElementInstanceMap.size() >= expected
        return true
    ...
    def validateAllPageable(String url, int expected) {
        def info = getFirstParticipantInfo(url)
        assert info.acNodeTemplateStateDefinitionMap.size() == expected
        return true
    }

    def validateAllNotPageable(String url, int expected) {
        def info = getFirstParticipantInfo(url)
        assert info.acNodeTemplateStateDefinitionMap.size() >= expected
        return true
    }

    def getParticipantInfo(String url) {
