...
class SupervisionMessagesTest {
    ...
    void testSendParticipantRegisterAck() {
        ...
        verify(participantAckPublisher).send(eq(false), any(ParticipantRegisterAck.class));
    }
    ...
    void testParticipantStatusReqPublisher() {
        ...
        verify(participantPublisher).send(eq(false), any(ParticipantStatusReq.class));
    }
    ...
    void testParticipantSyncPublisherAutomationComposition() {
        ...
        verify(participantPublisher).send(eq(false), any(ParticipantSync.class));
