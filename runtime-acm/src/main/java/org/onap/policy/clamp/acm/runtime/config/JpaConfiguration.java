...
public class JpaConfiguration extends JpaBaseConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean localContainerEntityManagerFactory(
            ...
            AcRuntimeParameterGroup acRuntimeParameterGroup) {

        return builder.dataSource(dataSource)
                .persistenceUnit(acRuntimeParameterGroup.getDatabaseProviderParameters().getPersistenceUnit())
    ...
    @Bean
    @Primary
    public static JpaProperties properties(AcRuntimeParameterGroup acRuntimeParameterGroup) {
        final var jpaProperties = new JpaProperties();
        jpaProperties.setShowSql(acRuntimeParameterGroup.isShowSql());
        jpaProperties.setDatabasePlatform(acRuntimeParameterGroup.getDatabasePlatform());
        return jpaProperties;
    }
